...
function equalCheckers.Vector3(v1: Vector3, v2: Vector3)
	return v1.X == v2.X and v1.Y == v2.Y and v1.Z == v2.Z
end

function equalCheckers.UDim2(u1: UDim2, u2: UDim2)
	return equalCheckers.UDim(u1.X, u2.X) and equalCheckers.UDim(u1.Y, u2.Y)
end
...
function equalCheckers.CFrame(cf1: CFrame, cf2: CFrame)
...
function equalCheckers.Color3(c1: Color3, c2: Color3)
	return c1.R == c2.R and c1.G == c2.G and c1.B == c2.B
end

function equalCheckers.UDim(u1: UDim, u2: UDim)
	return u1.Scale == u2.Scale and u1.Offset == u2.Offset
end

return equalCheckers
